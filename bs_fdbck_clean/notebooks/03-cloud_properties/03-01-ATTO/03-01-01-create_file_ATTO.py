...
fn1 = path_extract_latlon_outdata/model_name_noresm / case_name1 / f'{case_name1}.h1._{from_time1}-{to_time1}_concat_subs_{str_coordlims}.nc'
...
fn2 = path_extract_latlon_outdata/model_name_noresm / case_name2 / f'{case_name2}.h1._{from_time2}-{to_time2}_concat_subs_{str_coordlims}.nc'
