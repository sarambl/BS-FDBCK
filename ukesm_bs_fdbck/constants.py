...
## Root:
project_name = 'UKESM-BS-FDBCK'
project_name_output = 'UKESM-BS-FDBCK'
...
raw_data_path_echam = project_base_path / 'other_data' / project_name_output / 'ECHAM-SALSA'
raw_data_path_ukesm = project_base_path / 'other_data' / project_name_output / 'UKESM'
raw_data_path_ecEarth= project_base_path / 'other_data' / project_name_output / 'EC-Earth'/'ECE3_output_Sara'
