...
# %%
def launch_monthly_h1(case, issectional, max_launches=8, from_time='2008-01-01', to_time='2009-01-01'):
    """
    ...
    file = package_base_path / 'ukesm_bs_fdbck'/'preprocess'/'noresm'/'subproc_monthly_h1.py'
    # while loop:
    notdone = True
    while notdone:
        # Update status
