...
def noresm_fix(dtset):
    NCONC_noresm = ukesm_bs_fdbck.data_info.variable_info.sized_varListNorESM['NCONC']
    ...
    NMR_noresm = ukesm_bs_fdbck.data_info.variable_info.sized_varListNorESM['NMR']
...
def _ch_unit(dtset, typ, var):
    fac = ukesm_bs_fdbck.data_info.variable_info.default_units[typ]['factor']
    un = ukesm_bs_fdbck.data_info.variable_info.default_units[typ]['units']
    exceptions = ukesm_bs_fdbck.data_info.variable_info.default_units[typ]['exceptions']
