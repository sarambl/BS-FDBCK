import ukesm_bs_fdbck.util.slice_average.avg_pkg as avg_pkg
import ukesm_bs_fdbck.util.imports.get_pressure_coord_fields
from ukesm_bs_fdbck.util.slice_average.avg_pkg import maps
import ukesm_bs_fdbck.util.slice_average.avg_pkg.levlat
import ukesm_bs_fdbck.util.slice_average.avg_pkg.one_value
import ukesm_bs_fdbck.util.slice_average.avg_pkg.profiles
...
from ukesm_bs_fdbck.constants import get_input_datapath
...
def get_area_avg_nested(models, cases, varlist, area, from_time, to_time,
    ...
    for model in models:
        ...
        for case in cases:
            ...
            for var in varlist:
                # Check if data already calculated:
                ds_avg, var_loaded = ukesm_bs_fdbck.util.slice_average.avg_pkg.one_value.load_area_file_var(model,
                                                                                                       case,
                                                                                                       var,
                                                                                                       area,
                                                                                                       from_time,
                ...
                if not var_loaded:
                    ...
                    ds_avg = ukesm_bs_fdbck.util.slice_average.avg_pkg.one_value.get_average_area(dummy,
                                                                                             [var], case,
                                                                                             area, from_time,
                                                                                             to_time, model, pmin,
