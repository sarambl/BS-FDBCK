...
from bs_fdbck.constants import path_eusaar_data, path_eusaar_outdata, package_base_path  # path_eusaar_data
from bs_fdbck.data_info import get_nice_name_case
from bs_fdbck.util.plot.colors import get_case_col

p_histc = path_eusaar_data / 'HISTC/'
p_gen = path_eusaar_data / 'GEN/'
p_distc = path_eusaar_data / 'DISTC/'
station_table_path = package_base_path / 'bs_fdbck' / 'misc' / 'eusaar_table2_asmi2011.csv'
