...
from bs_fdbck.util.slice_average import area_mod
...
def _ch_unit(dtset, typ, var):
    fac = bs_fdbck.data_info.variable_info.default_units[typ]['factor']
    un = bs_fdbck.data_info.variable_info.default_units[typ]['units']
    exceptions = bs_fdbck.data_info.variable_info.default_units[typ]['exceptions']
