...
import os.path
from bs_fdbck.util.imports.hybridsig2pressure import hybsig2pres_vars
...
def get_pressure_coord_fields(case, varlist, from_time, to_time, history_field,
    ...
    :return:
    """
    varlist_get = list(set(varlist).union(set(bs_fdbck.data_info.variable_info.import_always_include)))
