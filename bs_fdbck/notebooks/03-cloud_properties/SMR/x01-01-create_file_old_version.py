...
# %%
ds_all['clfr'].where(ds_all['clfr']>0).plot.hist(bins=np.linspace(0,1))#x='cod',y='cod_incld',)
#ds_all.where(ds_all['cod']>=ds_all['cod_incld'])['cod_incld'].plot.hist(bins=np.arange(100),alpha=0.4)#x='cod',y='cod_incld',)


# %%
ds_all['cl_time'].where(ds_all['cl_time']>0).plot.hist(bins=np.linspace(0,1))#x='cod',y='cod_incld',)
ds_all['clfr'].where(ds_all['clfr']>0).plot.hist(bins=np.linspace(0,1))#x='cod',y='cod_incld',)
#ds_all.where(ds_all['cod']>=ds_all['cod_incld'])['cod_incld'].plot.hist(bins=np.arange(100),alpha=0.4)#x='cod',y='cod_incld',)
