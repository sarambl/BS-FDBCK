...
package_base_path = package_base_path.parent /'BS-FDBCK'
...
# %%
def launch_monthly_station_output(case, issectional, max_launches=3, from_time='2009-01-01', to_time='2011-01-01',
                                  history_field = '.h1.'):
    """
    ...
    if history_field =='.h2.':
        file = package_base_path / 'bs_fdbck'/'notebooks'/'x_forEscienceCourse'/'subproc_station_output_full_grid_h2.py'

    else:
        file = package_base_path / 'bs_fdbck'/'notebooks'/'x_forEscienceCourse'/'subproc_station_output_full_grid_h1.py'
